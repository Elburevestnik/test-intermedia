...
export class SpinnerComponent implements OnInit, OnDestroy, OnChanges, AfterViewInit, AfterViewChecked {
  public hidden = false;
  ...
  public ngAfterViewChecked(): void {
    // запуск setIntervals с изменением точек канваса запускает обнуружение изменений,
    // что не очень хорошо сказывается на производительности
    // можно использовать ngZone, который помогает контролировать отслеживание изменений
    // this.zone.runOutsideAngular in this.init()
    console.log('changes');
  }
